...
#if defined(I2C_MASTER_SCB_MODE)
...
/* Function-like macros for handling I2C MAster API names on SCB and UDB */
    ...
    #define I2C_LCD_MasterWriteBuf(slaveAddress, wrData, cnt, mode)  \
                                I2C_MASTER_I2CMasterWriteBuf(slaveAddress, wrData, cnt, mode)

    #define I2C_LCD_MasterReadStatus()     I2C_MASTER_I2CMasterStatus()
#else
    #define I2C_LCD_MasterWriteBuf(slaveAddress, wrData, cnt, mode)  \
                                I2C_MASTER_MasterWriteBuf(slaveAddress, wrData, cnt, mode)

    #define I2C_LCD_MasterReadStatus()     I2C_MASTER_MasterStatus()
...
#define I2C_LCD_DEFAULT_I2C_ADDRESS        ((uint8)((uint8)(39u) >> \
...
#if(I2C_LCD_IS_SCB_MASTER_USED)
    #define I2C_LCD_MODE_COMPLETE_XFER         (I2C_MASTER_I2C_MODE_COMPLETE_XFER)
    #define I2C_LCD_WRITE_COMPLETE             (I2C_MASTER_I2C_MSTAT_WR_CMPLT)
#else
    #define I2C_LCD_MODE_COMPLETE_XFER         (I2C_MASTER_MODE_COMPLETE_XFER)
    #define I2C_LCD_WRITE_COMPLETE             (I2C_MASTER_MSTAT_WR_CMPLT)
#endif /* I2C_LCD_IS_SCB_MASTER_USED */
